...
export default function ChatInput({ buttonHandler }) {
  ...
  const reset=(e)=>{
    ...
    else setImage(null);setVideo(null)
 ...
 const setFile=(file)=>{//funcion que convierte la imagen en datos legibles
  ...
  filereader.onload=()=>{//le decimos que hacer
    ...
    <div className={style.chat}>
      <form onSubmit={handlerSubmit}>
        <input
          ...
          value={message}
        />
         <input type="file" id="file" onChange={(e)=>{e.preventDefault(e);handleImage(e);reset(e)}} />
